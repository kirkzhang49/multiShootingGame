...
public class FPSController : NetworkBehaviour {
	...
	[SerializeField]
	private WeaponManager weapon_manage;
	...
	void PlayerMovement(){
		...
		inputY = Mathf.Lerp (inputY, inputY_Set, Time.deltaTime * 19f);//go from inputY to inputY_Set within Time
		...
		if (is_Grounded) {
			//here we are gonna to call crunch and sprint
